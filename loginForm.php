            ...
            <div class="row px-3 justify-content-center">
                <form action="" method="post" id="loginForm">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control form-control-lg rounded-none border-yellow-400 placeholder-yellow-400 shadow-none" placeholder="Username" name="user_email" require>
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text rounded-none bg-yellow-400 text-white border-none" id=""><i class="fas fa-key"></i></span>
                        <input type="password" class="form-control form-control-lg rounded-none border-yellow-400 placeholder-yellow-400 shadow-none" placeholder="Password" name="user_pass">
                    </div>
                    <div class="input-group mb-3 d-grid">
                        <button type="submit" class="btn rounded-none btn-lg border-yellow-400 hover:bg-yellow-400 hover:text-white text-yellow-400" name="loginU">Log in</button>
                    </div>
                    <div>
